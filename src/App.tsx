    ...
    <div className="min-h-screen relative" style={{background:"#282828",fontFamily:"Inter,'Segoe UI',system-ui,sans-serif"}}>
      ...
      <div style={{background:"#303030"}}>
        ...
        {addOpen&&<div style={{padding:"4px 6px",background:"#353535",borderTop:"1px solid #282828",borderBottom:"1px solid #282828"}}>
          ...
          {hasAny&&<button onClick={submit} style={{width:"100%",height:26,borderRadius:4,border:"none",background:"#D32222",color:"#fff",fontSize:12,fontWeight:700,cursor:"pointer",marginTop:4,letterSpacing:".03em",boxShadow:"0 2px 6px rgba(211,34,34,.4)"}}>🔒 Busy ({[...new Set([...typed,...sel])].length})</button>}
        </div>}
